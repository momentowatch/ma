...
export const SA3A_PRODUCTS: Sa3aProduct[] = [
  ...
  // Rolex
  { id: 'rolex-datejust', ref: 'CW-ROL-01', brand: 'Rolex', brandDir: 'male', folder: 'rolex-datejust', name: 'Rolex Datejust', subtitle: 'Jubilee-style bracelet with date window - quartz', price: 200, imageCount: 5, movement: 'quartz', gender: 'men', subCollection: 'Datejust Heritage', poster: 'male/posters/rolexx.webp' },
  { id: 'rolex-daytona', ref: 'CW-ROL-02', brand: 'Rolex', brandDir: 'male', folder: 'rolex-daytona', name: 'Rolex Daytona Chronograph', subtitle: 'Tachymeter bezel - quartz chronograph', price: 300, imageCount: 3, movement: 'chrono', gender: 'men', subCollection: 'Chronograph', poster: 'male/posters/rolexx.webp' },
  { id: 'rolex-gmt-master', ref: 'CW-ROL-03', brand: 'Rolex', brandDir: 'male', folder: 'rolex-gmt-master', name: 'Rolex GMT-Master', subtitle: 'Two-tone bezel with 24h hand - quartz', price: 210, imageCount: 7, movement: 'quartz', gender: 'men', subCollection: 'Sport & GMT', poster: 'male/posters/rolexx.webp' },
  { id: 'rolex-land-dweller', ref: 'CW-ROL-04', brand: 'Rolex', brandDir: 'male', folder: 'rolex-land-dweller', name: 'Rolex Land-Dweller', subtitle: 'Steel case and bracelet - quartz', price: 200, imageCount: 5, movement: 'quartz', gender: 'men', subCollection: 'Sport & GMT', poster: 'male/posters/rolexx.webp' },
  { id: 'rolex-oyster-perpetual', ref: 'CW-ROL-05', brand: 'Rolex', brandDir: 'male', folder: 'rolex-oyster-perpetual', name: 'Rolex Oyster Perpetual', subtitle: 'Steel Oyster-style bracelet - quartz', price: 210, imageCount: 8, movement: 'quartz', gender: 'men', subCollection: 'Sport & GMT', poster: 'male/posters/rolexx.webp' },
  { id: 'rolex-oyster-perpetual-ii', ref: 'CW-ROL-06', brand: 'Rolex', brandDir: 'male', folder: 'rolex-oyster-perpetual-ii', name: 'Rolex Oyster Perpetual II', subtitle: 'Steel Oyster-style bracelet - quartz', price: 210, imageCount: 5, movement: 'quartz', gender: 'men', subCollection: 'Sport & GMT', poster: 'male/posters/rolexx.webp' },
  // Tissot
